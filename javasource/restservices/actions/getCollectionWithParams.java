 ...
 * 
 */
public class getCollectionWithParams extends CustomJavaAction<Boolean>
{
	...
	public getCollectionWithParams(IContext context, String collectionUrl, IMendixObject requestData, java.util.List<IMendixObject> resultList, IMendixObject firstResult)
	{
		super(context);
	...
	public Boolean executeAction() throws Exception
	{
		...
		RestConsumer.getCollection(getContext(), collectionUrl, requestData, __resultList, __firstResult);
		return true;
		// END USER CODE
	}
